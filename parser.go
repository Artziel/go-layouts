...
var ErrMinValueRuleFail error = errors.New("min value or length rule fail")
var ErrMaxValueRuleFail error = errors.New("max value or length rule fail")
var ErrMinLengthValueRuleFail error = errors.New("min length value or length rule fail")
var ErrMaxLengthValueRuleFail error = errors.New("max length value or length rule fail")
